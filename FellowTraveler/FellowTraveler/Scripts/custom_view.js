ymaps.modules.define('MultiRouteCustomView', [
    ...
    function CustomView(multiRoute) {
    ...
    defineClass(CustomView, {
        ...
        rebuildOutput: function () {
            ...
            this.outputElement.html(
                this[processorName](this.multiRoute, this.stateChangeEvent)
            );
        },
        ...
        processSuccessRequest: function (multiRoute, e) {
        ...
        processFailRequest: function (multiRoute, e) {
